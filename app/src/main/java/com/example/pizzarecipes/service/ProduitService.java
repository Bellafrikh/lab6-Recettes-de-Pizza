...
public class ProduitService implements IDao<Produit> {
    ...
    private final List<Produit> cataloguePizzas = new ArrayList<>();
    ...
    private void initialiserDonnees() {
        this.ajouter(new Produit("BARBECUED CHICKEN PIZZA", 3.0, R.mipmap.pizza1, "35 min",
        ...
        this.ajouter(new Produit("BRUSCHETTA PIZZA ", 5.0, R.mipmap.pizza2, "35 min",
        ...
        this.ajouter(new Produit("SPINACH PIZZA", 2.0, R.mipmap.pizza3, "25 min",
        ...
        this.ajouter(new Produit("DEEP-DISH SAUSAGE PIZZA ", 8.0, R.mipmap.pizza4, "45 min",
        ...
        this.ajouter(new Produit("HOMEMADE PIZZA", 4.0, R.mipmap.pizza5, "50 min",
        ...
        this.ajouter(new Produit("PESTO CHICKEN PIZZA", 3.0, R.mipmap.pizza6, "50 min",
        ...
        this.ajouter(new Produit("LOADED MEXICAN PIZZA", 3.0, R.mipmap.pizza7, "30 min",
        ...
        this.ajouter(new Produit("BACON CHEESEBURGER PIZZA", 2.0, R.mipmap.pizza8, "20min",
        ...
        this.ajouter(new Produit("PIZZA MARGHERITA", 1.0, R.mipmap.pizza9, "30 min",
        ...
        this.ajouter(new Produit("PEPPERONI-SAUSAGE STUFFED PIZZA", 5.0, R.mipmap.pizza10, "45 min",
    ...
    @Override
    public Produit ajouter(Produit entite) {
        cataloguePizzas.add(entite);
        return entite;
    }

    @Override
    public Produit modifier(Produit entite) {
        for (int i = 0; i < cataloguePizzas.size(); i++) {
            if (cataloguePizzas.get(i).getIdentifiant() == entite.getIdentifiant()) {
                cataloguePizzas.set(i, entite);
                return entite;
            }
        }
        return null;
    ...
    public boolean supprimer(long identifiant) {
        return cataloguePizzas.removeIf(p -> p.getIdentifiant() == identifiant);
    }

    @Override
    public Produit rechercherParId(long identifiant) {
        for (Produit p : cataloguePizzas) {
    ...
    @Override
    public List<Produit> obtenirTout() {
        return Collections.unmodifiableList(cataloguePizzas);
    }
}
